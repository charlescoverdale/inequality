...
abstract: >
  ...
  dependency, and is available on CRAN.
draft: false
author:
...
**Polarisation.** @wolfson1994inequalities introduced a
bipolarisation index that is conceptually distinct from inequality:
the same Gini is consistent with a unimodal distribution and with a
bimodal "disappearing middle" distribution. @foster2010polarization
further develop this framework and extend it to Canada and the US.
...
\code{SI.POV.GINI}, for six economies: Sweden (from 1975), France (from 1970),
the United Kingdom (from 1970), the United States (from 1970),
Germany (from 1991), and Brazil (from 1981), through 2024. The Gini
values themselves are published; the case study's contribution is to
show how the package machinery handles the full observed record
