...
\textbf{Polarisation.} \citet{wolfson1994inequalities} introduced a
...
bimodal ``disappearing middle'' distribution. \citet{foster2010polarization}
...
{\centering \includegraphics[width=1\linewidth,alt={A line chart with calendar year on the horizontal axis and Gini coefficient on the vertical axis from about 22 to 60. Six country series are plotted at different start dates. Brazil sits well above the others, starting around 58 and declining to about 50. The United States climbs from 37 to 42. Sweden, France, and Germany cluster between 25 and 33 across the available period. The United Kingdom rises from 28 to 32 with most of the increase in the 1980s.},]{figures/fig6_wb_gini} 

}

\caption{Gini coefficient by country from the World Bank Poverty and Inequality Platform, each series from its first available year through 2024. Data: World Bank series \texttt{SI.POV.GINI}. Brazil shows the well-documented post-Bolsa-Familia decline from 57.9 in 1981 to 50.3 in 2024. The United States shows a steady rise from 37 in 1970 to 42 in 2024. Sweden, France, and the UK are broadly in the 25 to 33 band throughout. Germany data begins 1991 after reunification.}\label{fig:wb-gini}
\end{figure}
