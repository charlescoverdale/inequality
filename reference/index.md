...
Standard and generalised inequality indices
...
Subgroup and factor decomposition
...
Concentration index, Kakwani, and Reynolds-Smolensky
...
FGT and Sen poverty measures

- [`iq_poverty()`](https://charlescoverdale.github.io/inequality/reference/iq_poverty.md)
  : Poverty measures

## Mobility and Polarisation

Growth incidence curve, Wolfson polarisation, Lorenz curve
